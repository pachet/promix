...
function iterate ( method, fn, array ) {
	if ( !isArray(array) ) {
		return method.call(this, fn, array);
	}
...
function wrapIterate ( method, array, fn ) {
	if ( ! array ) {
		return method.call(this, fn, array);
	}

	if ( typeof array.then === 'function' ) {
		array.then((function interpose(results) {
			iterate.call(this, method, fn, results);
		}).bind(this), this.break.bind(this));

		return this;
	}

	iterate.call(this, method, fn, array);

	return this;
}

Exposure.prototype.each = Exposure.prototype.andEach = function each ( array, fn ) {
	return wrapIterate.call(this, this.and, array, fn);
};

Exposure.prototype.thenEach = function thenEach ( array, fn ) {
	return wrapIterate.call(this, this.then, array, fn);
};

Exposure.prototype.expunge = function expunge ( expunge_property ) {
	this.__internal.expunge(this.__internal.focus, expunge_property);
	return this;
};

Exposure.prototype.pipe = function pipe ( ) {
